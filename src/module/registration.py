...
def rigid(fixed_image_path, moving_image_path):
    ...
    sitk.WriteImage(elastixImageFilter.GetResultImage(), "src/temp/registration/rigid.nii")
...
def affine(fixed_image_path, moving_image_path):
    ...
    elastixImageFilter.Execute()
    sitk.WriteImage(elastixImageFilter.GetResultImage(),  "src/temp/registration/affine.nii")
...
def non_rigid(fixed_image_path, moving_image_path):
    ...
    sitk.WriteImage(elastixImageFilter.GetResultImage(), "src/temp/registration/non_rigid.nii")
