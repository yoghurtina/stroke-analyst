...
from module.utils import segmentation, get_segmented
...
def main():
    ...
    segmented_image_path = "src/temp/segmentation/segmented_image.jpg"
    mask_path = "src/temp/segmentation/mask_bgs.jpg"
