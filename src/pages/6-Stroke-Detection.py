...
if uploaded_in_previous_step:
    ...
    if canvas_result.json_data is not None:
        ...
        if bbox_array is not None:
            ...
            seg_results = seg_anything("src/temp/alignment/equalized_aligned_section.jpg", bbox_coords)
            ...
            if seg_results:
                ...
                mask1_hem1 = post_process_mask('src/temp/detection/mask1_hem1.jpg')
                mask2_hem1 = post_process_mask('src/temp/detection/mask2_hem1.jpg')
                mask3_hem1 = post_process_mask("src/temp/detection/mask3_hem1.jpg")
                save_array_as_image(mask1_hem1, 'src/temp/detection/mask1_hem1.jpg' )
                save_array_as_image(mask2_hem1, 'src/temp/detection/mask2_hem1.jpg' )
                save_array_as_image(mask3_hem1, 'src/temp/detection/mask3_hem1.jpg' )
                ...
                mask1_hem2 = post_process_mask('src/temp/detection/mask1_hem2.jpg')
                # mask2_hem2 = post_process_mask('src/temp/detection/mask2_hem2.jpg')
                # mask3_hem2 = post_process_mask('src/temp/detection/mask3_hem2.jpg')
                save_array_as_image(mask1_hem2, 'src/temp/detection/mask1_hem2.jpg' )
                # save_array_as_image(mask2_hem2, 'src/temp/detection/mask2_hem2.jpg' )
                # save_array_as_image(mask3_hem2, 'src/temp/detection/mask3_hem2.jpg' )
                ...
                # delete_foldercontents("/src/temp")
