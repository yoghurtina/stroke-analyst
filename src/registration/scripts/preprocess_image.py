...
# functions:
# convert images to 1200 dpi
# moving image resizing
# image normalization
...
# testing if the dpi is 1200
# print(moving_dpi.GetSize(), moving_dpi.GetOrigin(), moving_dpi.GetSpacing(), moving_dpi.GetDirection())
# print(fixed_dpi.GetSize(), fixed_dpi.GetOrigin(), fixed_dpi.GetSpacing(), fixed_dpi.GetDirection())
...
# # TESTING for dimensions after resize and padding
# print(fixed_dpi.GetSize())
# print(fixed_dpi.GetOrigin())
# print(fixed_dpi.GetSpacing())
# print(fixed_dpi.GetDirection())

# print(resized_moving_image.GetSize())
# print(resized_moving_image.GetOrigin())
# print(resized_moving_image.GetSpacing())
# print(resized_moving_image.GetDirection())
